...
def train(config):
	...
	if config.load_pretrain == True: #if you want to load pretrain model
	    DCE_net.load_state_dict(torch.load(config.pretrain_dir))
	train_dataset = dataloader.lowlight_loader(config.lowlight_images_path) #create dataset with path provided
	
	#wraps in a pytorch dataloader for batching and shuffling
